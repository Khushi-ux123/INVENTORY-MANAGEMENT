      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2">
          {sortedAndFilteredOrders.length > 0 ? (
                ...
                {sortedAndFilteredOrders.map(order => {
                  ...
                  return (
                    <div 
                      key={order.id} 
                      onClick={() => setSelectedOrder(order)}
                      className={`border rounded-2xl p-4 cursor-pointer transition-all hover:shadow-md flex flex-col justify-between relative overflow-hidden group ${
                        isSelected 
                          ? "bg-indigo-50/20 border-indigo-300 shadow-3xs" 
                          : "bg-white border-neutral-200 hover:border-neutral-300"
                      }`}
                    >
                      <div className="space-y-3.5">
                        <div className="flex items-center justify-between">
                          <span className="font-mono text-xs font-bold text-neutral-900 bg-neutral-100 px-2.5 py-0.5 rounded">
                            #{order.id}
                          </span>
                        ...
                        <div>
                          <div className="font-semibold text-neutral-800 text-sm truncate">{order.customerName}</div>
                          <div className="text-[10px] text-neutral-400 font-mono mt-0.5">ID: {order.customerId}</div>
                        </div>
                      </div>

                      <div className="mt-4 pt-3 border-t border-neutral-100/75 flex items-center justify-between">
                        <div>
                          <div className="text-[10px] text-neutral-400 font-semibold uppercase tracking-wider">Total Value</div>
                        ...
                        <div className="text-right">
                          <div className="text-[10px] text-neutral-400 font-semibold uppercase tracking-wider">Deducted Items</div>
                          <div className="text-xs font-bold font-mono mt-0.5 text-neutral-600">
                            {totalQty} {totalQty === 1 ? "unit" : "units"}
                          </div>
                        </div>
                      </div>

                      <div className="mt-3.5 pt-2 border-t border-neutral-100/60 flex items-center justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button 
                          onClick={(e) => { e.stopPropagation(); setSelectedOrder(order); }}
                          className="p-1.5 text-neutral-500 hover:text-indigo-600 hover:bg-indigo-50 border border-transparent rounded-lg transition-all cursor-pointer"
                        ...
                        <button 
                          ...
                          className="p-1.5 text-neutral-400 hover:text-red-600 hover:bg-neutral-50 border border-transparent rounded-lg transition-all cursor-pointer"
            ...
            <div className="bg-white border border-neutral-200/80 rounded-2xl shadow-xs p-14 text-center">
